      ...
      <MenubarMenu>
        ...
        <MenubarContent>
          <MenubarRadioGroup value="benoit">
            <MenubarRadioItem value="andy">Suhane</MenubarRadioItem>
            <MenubarRadioItem value="benoit">Vats</MenubarRadioItem>
            <MenubarRadioItem value="Luis">Devil</MenubarRadioItem>
          </MenubarRadioGroup>
          <MenubarSeparator />
